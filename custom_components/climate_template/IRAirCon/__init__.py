...
class IRAirCon(object):
    ...
    def _connect(self):
         connstr = "apiRegion=\"" + self.apiRegion + "\",apiKey=\"" + self.apiKey + "\",apiSecret=\"" + self.apiSecret + "\",apiDeviceID=\"" + self.remoteID + "\""
         self.c = c = tinytuya.Cloud(connstr)
    ...
    def getstatusfan(self):
        ...
        if result2 == 0:
            ...
            msg = "Error Converting value " + result2
        return msg
